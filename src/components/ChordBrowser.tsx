...
function InKeyChordCard({ degree, label, onAdd }: { degree: string; label: string; onAdd: () => void }) {
  return (
    <div className="group relative rounded-md border border-zinc-300 bg-white p-2 text-zinc-800 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100">
...
export default function ChordBrowser(props: ChordBrowserProps) {
  const { root, qualityId, extensionIds, onRootChange, onQualityChange, onExtensionsChange, onToggleExtension, onAddChordToPalette, voicingMode, onVoicingModeChange, inversion, onInversionChange, displayMode, onDisplayModeChange } = props
