...
export default function ChordBrowser(props: ChordBrowserProps) {
  const { root, qualityId, extensionIds, onRootChange, onQualityChange, onExtensionsChange, onToggleExtension, onAddChordToPalette, onPlayChord, voicingMode, onVoicingModeChange, inversion, onInversionChange, displayMode, onDisplayModeChange, mode } = props
