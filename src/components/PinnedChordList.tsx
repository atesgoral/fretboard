...
export default function PinnedChordList({
  ...
  return (
    ...
    >
        ...
        <>
          <ChordPlaybackSettingsMenu
            ...
            onSettingsChange={(settings) =>
              onAuditionSettingsChange(settings as ChordPlaybackSettings)
            }
      ...
      <h2
        className={`${collapsed ? 'pr-8' : 'mb-3 pr-24'} text-xs font-medium uppercase tracking-[0.08em] text-zinc-500 dark:text-zinc-400`}
      >
        Pinned chords
      </h2>
      {collapsed ? null : (
